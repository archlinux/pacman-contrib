...
Note: This can automated with `.githooks/prepare-commit-msg`:
`ln -rs .githooks/prepare-commit-msg .git/hooks`
or
...
------------------------
See https://docs.gitlab.com/user/project/merge_requests/creating_merge_requests/.
